...
(function renderMota() {
  ...
  content += `<img src = "${product.image}" alt = "" style = "margin:0 auto; display: block;width:509px; height:509px"/>`;
...
const renderComment = () => {
  ...
  for (let i = 0; i < 5; i++) {
    ...
    <div class = 'd-flex justify-content-between mt-3'>
      <div style="min-width:50px;margin-right:1rem">
...
<div>
    ...
    <div class = "d-flex justify-content-center justify-content-xl-start align-items-center">
      ...
      <div class = " text-center mx-3">
        <button class = "myBtnOutline">Thêm vào giỏ hàng</button>
      </div>
      <div class = " text-center">
      <button class = "myBtn">Mua ngay</button>
    </div>
    </div>
</div>
`;
